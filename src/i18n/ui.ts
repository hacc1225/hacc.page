export const ui = {
  'de': {
    title: 'Haccs Höhle',
    subtitle: 'Einige persönliche Notizen',
    description: 'Haccs persönlicher Blog. Hier geht es um das Lehrgeld, das ich beim Herumbasteln an Linux, allerlei Software und anderer schrulliger Hardware zahlen musste.',
    posts: 'Beiträge',
    tags: 'Schlagwörter',
    about: 'Über',
  ...
  'zh': {
    title: 'Hacc的小站',
    subtitle: '一些个人随笔',
    description: 'Hacc的个人博客，记录了我摆弄Linux在内的各种软件以及一些灵车硬件所踩过的坑。',
    posts: '文章',
    tags: '标签',
    about: '关于',
    toc: '目录',
