...
export const themeConfig: ThemeConfig = {
  ...
  site: {
    ...
    title: 'Hacc\'s Den',
    // site subtitle
    subtitle: 'Some personal jottings',
    // site description
    description: 'Hacc\'s personal blog. Sharing lessons learned the hard way from messing with Linux, all sorts of software, and other quirky hardware.',
  ...
  global: {
    ...
    moreLocales: ['en', 'de'], // ['de', 'en', 'es', 'fr', 'ja', 'ko', 'pl', 'pt', 'ru', 'zh', 'zh-tw']
